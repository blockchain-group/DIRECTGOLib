...
y = sum(((exp(-0.2*(1:10)).*sin(2*pi*0.4*(1:10) + 0.3) + ...
    exp(-0.3*(1:10)).*sin(2*pi*0.3*(1:10) + 0.1) + ...
    exp(-0.4*(1:10)).*sin(2*pi*0.6*(1:10) + 0.2)) - ...
    (exp(x(1)*(1:10)).*sin(2*pi*x(2)*(1:10) + x(3)) + ...
    exp(x(4)*(1:10)).*sin(2*pi*x(5)*(1:10) + x(6)) + ...
    exp(x(7)*(1:10)).*sin(2*pi*x(8)*(1:10) + x(9)))).^2);
end
