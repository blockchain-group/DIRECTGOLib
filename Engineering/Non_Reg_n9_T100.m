...
y = sum(((exp(-0.2*(1:100)).*sin(2*pi*0.4*(1:100) + 0.3) + ...
    exp(-0.3*(1:100)).*sin(2*pi*0.3*(1:100) + 0.1) + ...
    exp(-0.4*(1:100)).*sin(2*pi*0.6*(1:100) + 0.2)) - ...
    (exp(x(1)*(1:100)).*sin(2*pi*x(2)*(1:100) + x(3)) + ...
    exp(x(4)*(1:100)).*sin(2*pi*x(5)*(1:100) + x(6)) + ...
    exp(x(7)*(1:100)).*sin(2*pi*x(8)*(1:100) + x(9)))).^2);
end

function xl = get_xl(~)
    xl = [-1; 0; 0; -1; 0; 0; -1; 0; 0];
end

function xu = get_xu(~)
    xu = [0; 1; 1; 0; 1; 1; 0; 1; 1];
end
