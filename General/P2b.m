...
%
% Test problem P2b after reformulation contain 5 variables and 10 
...
y = -9*(x(4) + x(1)) - 15*(x(5) + x(2)) + 6*(((x(3)*x(4) + x(3)*x(5) -...
    x(4) - x(5))/2)) + 16*(x(4) + x(5) - ((x(3)*x(4) + x(3)*x(5) -...
    x(4) - x(5))/2)) + 10*(x(1) + x(2)); 
end
